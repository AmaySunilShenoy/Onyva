...
async def subscribe_route_updates(route_id: str,user_id : str = Depends(get_user_id), q: Optional[str] = Query(None, )):
    """
...
async def subscriptions(user_id : str = Depends(get_user_id), q: Optional[str] = Query(None, )):
    """
...
async def crime_report(route_id: str, crime_report: str,user_id : str = Depends(get_user_id), q: Optional[str] = Query(None, )):
    """
...
async def get_subscribed_reports(route_id: str, q: Optional[str] = Query(None, )):
    """
...
async def get_subscribed_reports(user_id : str = Depends(get_user_id), q: Optional[str] = Query(None, )):
    """
...
async def get_all_crime_reports( q: Optional[str] = Query(None, )):
    """
